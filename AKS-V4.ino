...
void setup() {
  ...
  Transmitted_Data.data[0] = 1;  // Kontrol verisi
  e22ttl.begin();
  delay(500);
  nextion.begin(9600);
...
void loop() {
  ...
  if (mcp2515.sendMessage(&Transmitted_Data) == MCP2515::ERROR_OK) {
    Serial.println("Kontrol verisi gönderildi");
  } else {
    Serial.println("Kontrol verisi gönderme hatası");
  }
