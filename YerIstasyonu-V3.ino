// Veriler int yerine byte olarak değiştirildi. Bu sayede kütüphane 8 bitlik veriler gönderdiğimize ikna oldu.
// Ring Buffer sorunu halledildi. 
// Süre ve veri gönderim algoritması iyileştirildi
